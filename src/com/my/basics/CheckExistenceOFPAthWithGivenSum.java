...
public class CheckExistenceOFPAthWithGivenSum {
	 ...
	 * 
	 * 
	 * example = node 3+8+10=21 or if 21-10-8-3=0 and left node==null and right
	 * node == null then node exists with the given sum
	 */
	...
	public static void main(String args[]) {
		 ...
		 */
		CheckExistenceOFPAthWithGivenSum tree = new CheckExistenceOFPAthWithGivenSum();
